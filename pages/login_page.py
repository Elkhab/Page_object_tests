...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        self.assertTrue(self.is_element_present(*LoginPageLocators.LOGIN_FORM, timeout=10)), "Login form is not presented"

    def should_be_register_form(self):
        # проверка, что есть форма регистрации на странице
        #assert self.is_element_present(*LoginPageLocators.REGISTER_FORM), "Register form is not presented"
        self.assertTrue(self.is_element_present(*LoginPageLocators.REGISTER_FORM)), "Register form is not presented"
